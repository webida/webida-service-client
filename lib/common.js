...
define([
    ...
    var privates = {
        ...
        parseLocationArgs: function parseBootArgs(args) {
            ...
            privates.isRemoteServer = args.isRemoteServer ? true : false;
        },
        ...
        getSimpleAuthApiKey: function getSimpleAuthApiKey() {
            if (tokenManager.accessToken) {
                return tokenManager.accessToken.text;
            } else {
    ...
    var publics = {
        // common module accessor.
        get logger() { return logger; },
        get api() { return WebidaRestfulApi; },

        // properties to access booting arguments
        ...
        get inDesktopApp() { return privates.inDesktopApp; },
        get isRemoteServer() { return privates.isRemoteServer; },

        init: function init(args) {
            var locationUri = new URI(window.location.href);
            var locationArgs = args || locationUri.query(true);
        ...
        // so, this function should be public for them
